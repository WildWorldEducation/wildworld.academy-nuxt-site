...
const _routes = [
  {
    name: "blog",
    path: "/blog",
    component: () => import('./blog-U4gj0KVH.mjs')
  },
  {
    name: "colouring-pages",
    path: "/colouring-pages",
    component: () => import('./colouring-pages-CefDmA8Y.mjs')
  },
  {
    name: "computer-science",
    path: "/computer-science",
    component: () => import('./computer-science-DI4TPqcr.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BRoAPqQn.mjs')
  },
  {
    name: "language",
    path: "/language",
    component: () => import('./language-B7hz06fJ.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-B9g8bxNH.mjs')
  },
  {
    name: "physics",
    path: "/physics",
    component: () => import('./physics-Dx6GvzZl.mjs')
  },
  {
    name: "toddlers",
    path: "/toddlers",
    component: () => import('./toddlers-Dixa-e3c.mjs')
  }
];
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_RouterLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(` Computer Science `);
      } else {
        return [
          createTextVNode(" Computer Science ")
        ];
      }
    }),
    _: 1
  ...
  _push(ssrRenderComponent(_component_RouterLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<span${_scopeId}>Colouring Pages</span>`);
      } else {
        return [
          createVNode("span", null, "Colouring Pages")
        ];
      }
    }),
    _: 1
  ...
  _push(`</li></ul><ul class="navbar-nav d-flex"><li class="nav-item me-2">`);
  _push(ssrRenderComponent(_component_RouterLink, {
    to: "/login",
  ...
  _push(`</li></ul></div></div></nav></header><div class="container">`);
